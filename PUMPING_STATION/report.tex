...
\begin{tikzpicture}[
    font=\scriptsize,
    step/.style={draw, thick, minimum width=2.2cm, minimum height=0.55cm},
    initstep/.style={step, double, double distance=1.5pt},
    trans/.style={draw, thick, minimum width=0.6cm},
    yscale=0.85
]
\node[initstep] (s0) at (0,5) {S0: 0 bombas};
\node[trans] (t01) at (0,4.55) {};
\node[step] (s1) at (0,4) {S1: B\_líder ON};
\node[trans] (t12) at (0,3.55) {};
\node[step] (s2) at (0,3) {S2: 2 bombas ON};
\node[trans] (t23) at (0,2.55) {};
\node[step] (s3) at (0,2) {S3: 3 bombas ON};
\node[trans] (t34) at (0,1.55) {};
\node[step] (s4) at (0,1) {S4: 4 bombas ON};
...
\node[right] at ($(t01.east)+(0.15,0)$) {\scriptsize M\_LISTO $\wedge$ I\_START};
\node[right] at ($(t12.east)+(0.15,0)$) {\scriptsize $Q{>}50$ TON 10s};
\node[right] at ($(t23.east)+(0.15,0)$) {\scriptsize $Q{>}100$ TON 10s};
\node[right] at ($(t34.east)+(0.15,0)$) {\scriptsize $Q{>}150$ TON 10s};

% Retorno (retroceso) - lineas punteadas a la izquierda
\draw[thick,dashed,-{Stealth[length=2mm]}] (s4.west) -- ++(-1.3,0) -- ($(t34.west)+(-1.3,0)$) -- (t34.west);
\node[left, align=right] at (-1.35,1.3) {\scriptsize $Q{<}150$\\TON 30s};
\draw[thick,dashed,-{Stealth[length=2mm]}] (s3.west) -- ++(-1.3,0) -- ($(t23.west)+(-1.3,0)$) -- (t23.west);
\node[left, align=right] at (-1.35,2.3) {\scriptsize $Q{<}100$\\TON 30s};
\draw[thick,dashed,-{Stealth[length=2mm]}] (s2.west) -- ++(-1.3,0) -- ($(t12.west)+(-1.3,0)$) -- (t12.west);
\node[left, align=right] at (-1.35,3.3) {\scriptsize $Q{<}50$\\TON 30s};
\draw[thick,dashed,-{Stealth[length=2mm]}] (s1.west) -- ++(-1.3,0) -- ($(t01.west)+(-1.3,0)$) -- (t01.west);
\node[left, align=right] at (-1.35,4.3) {\scriptsize I\_STOP $\vee$\\ M\_FALLA\_GRAL};
\end{tikzpicture}
...
\lstinputlisting[caption={Equivalente estructurado consolidado de la lógica LAD + SFC}, label={lst:consolidado}]{simulations/logica_consolidada.txt}
